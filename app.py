...
# ---- 3. KI FUNKTIONEN MIT MODELL 3.5 FLASH & RATE LIMITER ----
def initialisiere_ki(api_key):
    try:
        # HIER GEÄNDERT: Nutzt jetzt den neuen Client-Aufbau des SDKs
...
def frage_ki_assistent(client, frage, satz_daten):
    ...
    try:
        # HIER GEÄNDERT: Neuer Client-Aufruf mit gemini-3.5-flash
...
# HIER GEÄNDERT: Variable umbenannt, um zu verdeutlichen, dass sie nun den neuen Client hält
